...
struct Geom_RVE{
			...
			bool mark;
			string shape;
			Point_3D origin;												//Define an origin point for a RVE ( If the RVE is a cuboid, this point is the lower-left-front point of the RVE,
																					//if the RVE is a cylinder, this point is the center of the bottom circle. If this RVE is a cylinder, the default RVE is a Z-direction cylinder.)
			...
			int cut_num;														//Define the number of cutoff times n (n: the maxmum size - n*step_length(delta), n>=0)
			double cyl_radius;												//Define the radius of top and bottom circles of the cylinder
