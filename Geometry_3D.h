...
//---------------------------------------------------------------------------
//Structural data for a cylinder
struct cylinder
{	
	Point_3D bottom_center;			//Define an center point at the bottom circle of the cylinder
	double radius, length;				//Define radius of the bottom circle and the length of the cylinder
	double volume;							//Define the volume of the cylinder
};
#endif
//===========================================================================
